...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section
        id="definition"
        className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/50 pb-20 pt-28 md:pb-32 md:pt-36"
      >
        <div className="pointer-events-none absolute -right-32 -top-32 h-96 w-96 rounded-full bg-accent-blue/10 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-20 -left-20 h-72 w-72 rounded-full bg-deep-blue/5 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="mt-6 max-w-md text-base leading-relaxed text-gray-600 md:text-lg font-medium">
            ...
            >
              <Image
                ...
                width={800}
                height={800}
                className="w-full rounded-3xl shadow-xl object-cover aspect-video lg:aspect-square border border-white/50"
              />
            </motion.div>
          </div>
          ...
          >
            <div className="rounded-3xl border border-white/60 bg-white/70 p-6 backdrop-blur-xl md:p-8 shadow-xl">
              ...
              <div className="mx-auto aspect-[4/3] max-w-2xl overflow-hidden rounded-2xl bg-white shadow-sm border border-gray-100 relative">
                <Image
      ...
      {/* ═══════ CTA Section ═══════ */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-sky-50 py-20 border-t border-blue-100">
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              href="#definition"
              className="flex items-center gap-2 rounded-2xl border border-gray-200 bg-white px-8 py-4 font-bold text-gray-600 shadow-sm transition-all duration-300 hover:bg-gray-50 hover:text-deep-blue"
            >
              처음부터 다시 보기
            </a>
          </div>
