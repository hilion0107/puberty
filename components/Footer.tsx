        ...
        <footer className="w-full bg-[#f8f9fa] border-t border-gray-200 py-5 text-gray-600 font-pretendard">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-4">
                ...
                <div className="flex flex-col gap-3 w-full md:w-2/3">
                    ...
                    <div className="text-[13px] leading-snug text-gray-500 space-y-0.5">
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/3 md:items-end">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-4 pt-3 border-t border-gray-200/60 flex flex-col items-center justify-center text-[11px] text-gray-400">
